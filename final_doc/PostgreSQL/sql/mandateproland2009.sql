-- Function: public.mandateproland2009()

-- DROP FUNCTION public.mandateproland2009();

CREATE OR REPLACE FUNCTION mandateproland2009()
...
$BODY$
	...
	BEGIN
		...
		drop table if exists ps;
               ...
               create temp table dm as (select * from direktmandate2009);
               create temp table bt as (select * from btmandatepartei2009);
               create temp table ps as (select * from zweitstimmenproland2009);
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION mandateproland2009()
  OWNER TO postgres;