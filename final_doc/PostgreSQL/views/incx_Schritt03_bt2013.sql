...
CREATE OR REPLACE FUNCTION db.getdivisormaxbt2013 () 
RETURNS integer AS $$
	DECLARE 
		direction integer;
		div integer := 0;
...
CREATE OR REPLACE VIEW db.btmandatepartei2013 AS (

WITH div as (SELECT * FROM db.getdivisormaxbt2013())
